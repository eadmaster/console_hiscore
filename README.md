...
Currently we have:
 ...
 - a MAME `console_hiscore` plugin forked from the [official one](https://github.com/mamedev/mame/tree/master/plugins/hiscore) with support for cart and cdrom images (merged since [v0.219](https://github.com/mamedev/mame/pull/6130), kept here for older versions);
